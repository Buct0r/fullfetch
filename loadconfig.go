...
func loadConfig(scheme string) {
	...
	actions := map[string]func(string, string){
		...
		"mb":           func(color string, reset string) { displayMB(color, reset) },
		"memory":       func(color string, reset string) { displayMemory(color, reset) },
		"memorymodels": func(color string, reset string) { displayRamModel(color, reset) },
		"swap":         func(color string, reset string) { displaySwap(color, reset) },
		"packages":     func(color string, reset string) { displayPackages(color, reset) },
